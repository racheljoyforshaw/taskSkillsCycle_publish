...
We use three different specifications to estimate the relationship between the economic cycle and tasks and skills. The first, in section \ref{sec:4digit},  is closest to existing literature. However, whereas this literature models the intensive decision of whether to there is an occupational change, our econometric specification also capture the extensive decision of whether there is a task change by using a Tobit specification on 4-digit occupational code data.

...
with open(cwd + '/Results/tobit_temp_2000s.tex', 'r') as file:
	data = file.readlines()
data[0] =''
data[4] = ' &\multicolumn{2}{c}{(1) Tobit at 4-digit}  &\multicolumn{2}{c}{(2) Tobit at 1-digit}  &\multicolumn{4}{c}{(3) Double Hurdle at 4-digit} \\\\ \cmidrule(l{2pt}r{2pt}){2-3} \cmidrule(l{2pt}r{2pt}){4-5} \cmidrule(l{2pt}r{2pt}){6-9}\n'

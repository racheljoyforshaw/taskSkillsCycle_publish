...
*xi: dblhurdle angSep_CASCOT_stdz_dh `controls_dh_2' [pw=lgwt], ll(`angSep_leftLimit_dh') peq(`controls_dh_1' `exclusion_restriction') correlation
*eststo angSep_CASCOT_dh_`trans'
*gen used_`trans'=e(sample)

*xi: dblhurdle modOfMod_CASCOT_stdz_dh `controls_dh_2' [pw=lgwt], ll(`modOfMod_leftLimit_dh') peq(`controls_dh_1' `exclusion_restriction') correlation
*eststo modOfMod_CASCOT_dh_`trans'
...
* output to latex file 
		*esttab angSep_tobit_CASCOT_t modOfMod_tobit_CASCOT_t angSep_tobit_CASCOT_AGG modOfMod_tobit_CASCOT_AGG probit_EE angSep_tobit_CASCOT_h modOfMod_tobit_CASCOT_h using Results/tobit_temp_2000s.tex, replace  star(* 0.10 ** 0.05 *** 0.01) se mtitles nogaps pr2 r2 margin  ///
		...
		esttab angSep_CASCOT_dh_ALL  angSep_CASCOT_dh_EE angSep_CASCOT_dh_IUE modOfMod_CASCOT_dh_ALL modOfMod_CASCOT_dh_EE modOfMod_CASCOT_dh_IUE using Results/dh_temp_ALL_28062022.tex, replace  star(* 0.10 ** 0.05 *** 0.01) se mtitles nogaps pr2 r2 margin  ///
		b(a2) ///
...
* output to latex file 
		*esttab angSep_tobit_CASCOT_t modOfMod_tobit_CASCOT_t angSep_tobit_CASCOT_AGG modOfMod_tobit_CASCOT_AGG probit_EE angSep_tobit_CASCOT_h modOfMod_tobit_CASCOT_h using Results/tobit_temp_2000s.tex, replace  star(* 0.10 ** 0.05 *** 0.01) se mtitles nogaps pr2 r2 margin  ///
		...
		esttab angSep_p_CASCOT_ALL using Results/probit_temp_ALL_28062022.tex, replace  star(* 0.10 ** 0.05 *** 0.01) se mtitles nogaps pr2 r2 margin  ///
		b(a2) ///
...
save Data/regressionData_2q_5q_post.dta, replace

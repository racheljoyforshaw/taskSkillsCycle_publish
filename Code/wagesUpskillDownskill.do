/***********************************************************
**  Real wage changes by the percentile
************************************************************/

clear all
set more off
capture: set memory 500m
use Data/all_variables_5q.dta, clear
...
** Since Labour force survey uses negative value, -8 or-9, to denote "missing" and "is not applied", we change them into "." to avoid potential mistake. 
  ...
  local wage_vars grsswk1 grsswk5 
...
local mov_cond "& modOfMod_CASCOT>0"
}
...
shell $my_python_path Code/real_wage_change.py
